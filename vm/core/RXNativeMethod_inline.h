...
RX_INLINE bool RXObject_isNativeMethod(const RXObject_t* self) {
    return (RXObject_coreData(self).flags & RXObject_flagIsNativeMethod) != 0;
}

RX_INLINE void RXObject_setIsNativeMethod(RXObject_t* self) { 
 ...
 */
RX_INLINE RXObject_t* RXNativeMethod_activate(RXObject_t* self, RXObject_t* receiver, RXObject_t* context, int argumentCount) {
 ...
 */
RX_INLINE void RXNativeMethod_push(RXObject_t* object) {
 ...
 */
RX_INLINE void RXNativeMethod_pop(int offset) {
 ...
 */
RX_INLINE RXObject_t* RXNativeMethod_argumentAt(int index) {
